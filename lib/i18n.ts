...
export const dictionaries = {
  en: {
    ...
    home: {
      ...
      newsTitle: "Release News",
      newsSubtitle: "Fresh release notes, episode drops, animation updates, festivals, and cinema events.",
      sections: {
        "top-imdb": {
          title: "Top 250 IMDb",
        ...
        "persian-movies": {
          ...
          subtitle: "Iranian cinema with Persian posters, cast, story, and direct quality links.",
        },
        "recent-films": {
          title: "Recent Film",
    ...
    people: {
      ...
      history: "History",
      historyNote: "{name} appears in {count} indexed titles across SarvNema. The timeline below is built from movies and series already connected to this actor in the catalog.",
      historyUnknown: "Unknown",
      homeTitle: "Popular Actors",
      homeSubtitle: "A ranked cast index based on works, ratings, recency, and known titles.",
      knownFor: "Known for",
      movies: "movies",
      pageTitle: "Top Actors",
      people: "people",
      series: "series",
      top100: "Top 100",
      works: "works",
  ...
  fa: {
    ...
    home: {
      ...
      newsTitle: "خبرهای تازه",
      newsSubtitle: "خبرهای انتشار، قسمت های جدید، انیمیشن، جشنواره ها و رویدادهای سینمایی.",
      sections: {
        "top-imdb": {
          title: "۲۵۰ برتر IMDb",
        ...
        "persian-movies": {
          ...
          subtitle: "سینمای ایران با پوستر، بازیگران، داستان و لینک های مستقیم کیفیت ها.",
        },
        "recent-films": {
          title: "فیلم های جدید",
    ...
    people: {
      ...
      age: "سن",
      career: "مسیر کاری",
      filmography: "فیلموگرافی",
      history: "تاریخچه",
      historyNote: "{name} در {count} عنوان ثبت شده در سرو‌نما حضور دارد. تایم‌لاین پایین از فیلم‌ها و سریال‌هایی ساخته شده که در کاتالوگ به این بازیگر وصل هستند.",
      historyUnknown: "نامشخص",
      homeTitle: "بازیگران محبوب",
      homeSubtitle: "رتبه بندی بر اساس تعداد آثار، امتیازها، تازگی آثار و عنوان های شناخته شده.",
      knownFor: "شناخته شده با",
      movies: "فیلم",
      pageTitle: "برترین بازیگران",
      people: "نفر",
      series: "سریال",
      top100: "۱۰۰ نفر برتر",
      works: "اثر",
