...
export const KIDS_RESOURCES: KidsItem[] = [
  ...
  { id: "simple-face", title: "این صورت من است؛ آموزش اعضای بدن", categories: ["language", "music", "science"], sourceUrl: "https://supersimple.com/song/this-is-my-face/", provider: "Super Simple" },
  { id: "simple-spy", title: "بازی I Spy؛ دیدن و واژه‌آموزی", categories: ["language", "science", "fun"], sourceUrl: "https://supersimple.com/song/i-spy/", provider: "Super Simple" },
  { id: "simple-birthday", title: "تولد مبارک؛ ترانهٔ انگلیسی کودک", categories: ["language", "music", "fun"], sourceUrl: "https://supersimple.com/song/happy-birthday-to-you/", provider: "Super Simple" },
  ...
  { id: "bc-feelings", title: "احساسات، احساسات‌اند؛ آموزش زبان", categories: ["language", "feelings", "music"], sourceUrl: "https://learnenglishkids.britishcouncil.org/listen-watch/songs/feelings-are-feelings", provider: "British Council" },
  { id: "bc-bear-sue", title: "خرسی به نام سو؛ قصه و ترانهٔ انگلیسی", categories: ["language", "story", "music"], sourceUrl: "https://learnenglishkids.britishcouncil.org/listen-watch/songs/bear-named-sue", provider: "British Council" },
  ...
  { id: "aparatkids-alphabet", title: "آموزش الفبا با ماه منیر", categories: ["language", "music", "story"], sourceUrl: "https://www.aparatkids.com/m/85672", provider: "آپارات کودک · دیدیو کیدز" },
  { id: "aparatkids-scratch", title: "انیمیشن‌سازی کودکان با اسکرچ", categories: ["science", "art", "fun"], sourceUrl: "https://www.aparatkids.com/m/121473", provider: "آپارات کودک" },
  { id: "aparatkids-astronomy", title: "نجوم برای بچه‌ها؛ کارگاه آموزشی", categories: ["science", "fun"], sourceUrl: "https://www.aparatkids.com/m/100033", provider: "آپارات کودک · سازمان فضایی ایران" },
  { id: "aparatkids-animal-farm", title: "مزرعهٔ حیوانات؛ آموزش زبان", categories: ["language", "science", "story"], sourceUrl: "https://www.aparatkids.com/m/a7fvt", provider: "آپارات کودک" },
  { id: "aparatkids-vet-vida", title: "ویدا دامپزشک", categories: ["science", "language", "feelings"], sourceUrl: "https://www.aparatkids.com/m/163889", provider: "آپارات کودک" },
  { id: "aparatkids-new", title: "تازه‌های آپارات کودک", categories: ["movie", "series", "fun"], sourceUrl: "https://www.aparatkids.com/tag/10291687", provider: "آپارات کودک" },
  { id: "iranseda-kids", title: "ایران‌صدا کودک؛ قصه، شعر و آموزش", categories: ["story", "music", "language", "sleep"], sourceUrl: "https://kids.iranseda.ir/", provider: "ایران‌صدا کودک" },
  { id: "persian-kids", title: "یادگیری فارسی با بازی و قصه", categories: ["language", "story", "art"], sourceUrl: "https://persian.kids/", provider: "Persian.Kids" },
  ...
  { id: "aparatkids-alphabet-alef", title: "آموزش الفبا با ماه منیر؛ حرف الف", kind: "embed" as const, categories: ["language", "music", "story"], ages: ["3-5", "6-8"], sourceUrl: "https://www.aparatkids.com/w/knri4", embedHash: "knri4", provider: "آپارات کودک · دیدیو کیدز", note: "اپیزود رسمی آموزش حرف الف؛ پیش از تأیید، همراه کودک بررسی کنید." },
  { id: "aparatkids-astronomy-1", title: "نجوم برای بچه‌ها؛ فصل اول قسمت اول", kind: "embed" as const, categories: ["science", "fun"], ages: ["9-12"], sourceUrl: "https://www.aparatkids.com/w/chwsk", embedHash: "chwsk", provider: "آپارات کودک · سازمان فضایی ایران", note: "کارگاه رسمی نجوم؛ برای کودک بزرگ‌تر و همراهی والدین پیشنهاد می‌شود." },
