          ...
          <div className={styles.heroGrid}>
            ...
            <div className={styles.copy}>
              ...
              <div className={styles.actions}>
                ...
                {best && <DownloadButton href={best.url} title={title} quality={best.quality ?? undefined} itemId={item.imdbCode} posterUrl={posterUrl} label={fa ? `بهترین فایل · ${best.quality || "دانلود"}` : `Best file · ${best.quality || "Download"}`} />}
